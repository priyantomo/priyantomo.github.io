	...
	<div class="container" style="margin-top:20px">
		...
		<form action="edit dosen.php?kode_dosen=<?php echo $kode_dosen; ?>" method="post">
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="text" name="kode_dosen" class="form-control" size="4"
						value="<?php echo $data['kode_dosen']; ?>" readonly required>
				</div>
			</div>
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">NAMA DOSEN</label>
				<div class="col-sm-10">
					<input type="text" name="nama_dosen" class="form-control" value="<?php echo $data['nama_dosen']; ?>"
						required>
				</div>
			</div>
